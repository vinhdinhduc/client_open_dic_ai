...
export default function SearchHistoryPage() {
  ...
  const fetchHistory = useCallback(async () => {
    try {
      ...
      toast.error("Không thể tải lịch sử tìm kiếm");
    } finally {
      setLoading(false);
    }
  }, [currentPage]);
      ...
      <div className="history-page">
        ...
        {loading ? (
          ...
          <div className="history-page__empty">
            ...
            <p>
              {searchFilter
                ? "Thử lọc với từ khóa khác"
                : "Khi bạn tìm kiếm thuật ngữ, lịch sử sẽ xuất hiện ở đây"}
            </p>
          </div>
        ) : (
        ...
        {showClearConfirm && (
          ...
          >
            ...
            >
              ...
              <p>
                Hành động này sẽ xóa tất cả {totalItems} lượt tra cứu và không
                thể hoàn tác.
              </p>
